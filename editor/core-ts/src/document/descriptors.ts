...
/**
 * Область жизни дескриптора. Значение одно и другого не будет; константа — то
 * место, откуда его берёт каталог ED-30, чтобы внешний потребитель знал: ссылка,
 * сохранённая между сессиями, недействительна.
 */
