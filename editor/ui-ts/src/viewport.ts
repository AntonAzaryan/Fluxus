 ...
 * договорённостью:
 *
 * - узел кадра не несёт ни одного класса, кроме `.fx-viewport`: правила хрома
 *   красят по классу хрома, а взять его кадру неоткуда — виджет других не
 *   ставит и произвольных детей не принимает;
