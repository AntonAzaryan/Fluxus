...
/**
 * Заголовок раздела — одна и та же полоса во всех зонах и областях (ED-22,
 * ED-24). Виджетом, а не голым классом на месте: разделов в редакторе больше
 * десятка, и написанный руками класс — это способ завести четырнадцатый,
 * отличающийся от остальных ровно тем, что о нём забыли.
 */
export function sectionTitle(text: UiText): UiNode {
  return el('div', { classes: ['fx-section'], text });
}
