/* eslint-disable max-lines -- таблица правил визуального языка, а не логика:
   длина здесь есть длина данных (ED-22), и делить её значит делить один
   каскад на два файла. Роли правил проверяет visualLanguage.test.ts обходом
   этой же таблицы. */
/**
