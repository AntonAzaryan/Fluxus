 ...
 *
 * ID требований change'а здесь не цитируются намеренно: до архивации дельты
 * `spec-graph check` посчитал бы такую цитату висячей ссылкой на неопределённый
 * ID. Названия сценариев взяты из текста требования дословно.
 */
