...
describe('PERF-4: голден-гейт стоимости на записанных матчах (CLI-10)', () => {
  ...
  it('QUAL-1: значения ручек приезжают стенду контроллером, а не мимо него', () => {
    ...
    // террейн (две ручки — плотность разбиения кривизны и потолок числа
    // смешиваемых слотов текстурирования, REND-39), вода (три ручки —
    // источники ряби, слои детали и плотность выборки глубины, REND-35),
    // модели (две ручки), частицы. Подсистема
