...
export class MatchClient {
   ...
   * `inputDelay`» — нормирована NTR-10 («Оценка серверного тика»), а не выбрана
   * этой сборкой: на неё опирается потолок адаптивного запаса разметки (NTR-7),
   * и вторая реализация, выбравшая другой запас, получила бы другую границу
   * потери ввода. Кадры уезжали бы всё дальше в будущее, пока не начали бы выпадать
