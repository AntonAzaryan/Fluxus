 ...
 *
 * Поддерживается только трёхмерная таблица: одномерная (`LUT_1D_SIZE`) — это
 * кривая на канал, другой механизм и другая выборка, и молча подставить вместо
 * неё трёхмерную значило бы нарисовать не то, что в файле.
 *
