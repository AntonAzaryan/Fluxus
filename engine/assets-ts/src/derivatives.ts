/**
 * Запечённые производные модели (ASSET-11): данные, посчитанные заранее из
 ...
 * разделяются не теми же потребителями. LOD-цепочки (ASSET-11, REND-22) здесь
 ...
 *
 * ДЕТЕРМИНИЗМ (ASSET-11) держится тем, что запекание — чистая функция входа и
...
/** Запечённые производные одной модели (ASSET-11). */
...
/**
 * Ответ на запрос производных (ASSET-11): они есть — либо их нет, и отсутствие
...
/**
 * Запекает производные модели (ASSET-11). Чистая функция: одинаковый вход и
...
/**
 * Кэш производных по идентичности ассета (ASSET-2, ASSET-11): запекание — один
...
/**
 * Производные модели из кэша; при первом запросе — запекает (ASSET-11).
