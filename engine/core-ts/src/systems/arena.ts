 ...
 *
 * TimeScale (TIME-5): игнорирует — работа системы позиционная (принадлежность
 * кругу и уровень пола), счётчиков времени у неё нет вовсе; расписание сужения
 * радиуса ведёт система сцены и решает за себя сама.
 */
