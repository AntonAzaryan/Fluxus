 ...
 * их тождественность обеспечивает хеш `worldInit`, DET-1) и ёмкости мира (она
 * целиком лежит в плоской форме мира, то есть в том же хеше `worldInit`).
 * Величина, сверяемая дважды, только размывает вопрос, на который отвечает
 * каждая из двух проверок.
 *
