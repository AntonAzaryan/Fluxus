...
describe('мозг: замерший мир и разрыв непрерывности', () => {
  /**
   * Идущий бот: дистанция боя короче дистанции до человека, поэтому выигрывает
   * «давить» — цель steering'а стоит на противнике, и мозг отдаёт ненулевое
   * движение. Шум прицела ненулевой намеренно: держание обязано повторить
   * последний ОТДАННЫЙ прицел вместе с шумом, и на чистой базе микро-слоя
   * равенство прицелов было бы совпадением нулей.
   */
