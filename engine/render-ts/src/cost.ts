...
export interface RenderCostCounters {
   ...
   * является ни в каком прочтении (PERF-2). Именно на этом счётчике и виден
   * пресетный рычаг яруса (QUAL-3): смена `models.defaultTier` пересобирает
   * ровно записи, ярус не назвавшие.
   */
   ...
   * состояния GPU в ней нет (PERF-3).
   */
