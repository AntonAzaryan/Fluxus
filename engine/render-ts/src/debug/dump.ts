 ...
 *   функция, типизированный массив), отвергается адресно — с путём поля. Это и
 *   есть механическая проверка самодостаточности пробы (RDBG-2): ссылка на живую
 *   структуру рендера в дамп попросту не пролезает.
