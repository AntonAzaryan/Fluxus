 ...
 *
 * У документного продюсера (REND-11) оба входа поверхности мутабельны:
 *
...
export class VisualSurfaceSource {
  ...
  /**
   * Сетка пересчитана ядром (TERR-5) — например кистью уровней (ED-10).
  ...
  /**
   * Карта кривизны из памяти (ED-11, ED-15): несохранённый документ кисти.
