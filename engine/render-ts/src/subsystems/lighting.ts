/**
 * Подсистема освещения сцены (REND-27) за контрактом REND-8: она владеет источниками
 ...
 * Поэтому режим `hybrid` (REND-28) — ПАРА направленных источников с одинаковым
 ...
 *
 * Сама подсистема ярусов не назначает (REND-28): их сообщают владельцы объектов
