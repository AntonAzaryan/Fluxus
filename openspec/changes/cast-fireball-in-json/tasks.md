...
- [ ] 3.4 Прогнать демо вручную (`npm run dev -w @game-mvp/client`): каст летит в сторону клика, торс доворачивается (REND-5), дыра в полу на затухании по-прежнему появляется
