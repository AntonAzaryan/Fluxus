 ...
 * периметр — обрыв в один уровень без рампы, то есть непроходим.
 */
interface RampRoute {
...
const RAMP_ROUTES: readonly RampRoute[] = [
  ...
  // СВ: полоса рампы в колонке 28, вход с земли колонки 26.
  { name: 'СВ', level: PLATEAU_LEVEL, path: [[26.5, 24.5], [26.5, 14.5], [29.5, 14.5]] },
  // ЮЗ: полоса рампы в колонке 19, вход с земли колонки 22.
  { name: 'ЮЗ', level: PLATEAU_LEVEL, path: [[22.5, 24.5], [22.5, 32.5], [17.5, 32.5]] },
  // ЮВ: полоса рампы в колонке 28, вход с земли колонки 24.
