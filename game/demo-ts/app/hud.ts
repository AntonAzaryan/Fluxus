  ...
  return {
    entries: [
      ...
      },
      {
        ...
        // Размещение по мировому якорю над героем (HUD-10, REND-41) остаётся
        // возможностью записи (`anchor`), но демо её не берёт: полоса над
        // макушкой спорила с прицелом и телеграфами в бою, а здоровье и так
        // читается рядом с портретом. Размещение — запись, не код (HUD-4).
        widget: 'hp-bar',
        zone: 'bottom-left',
