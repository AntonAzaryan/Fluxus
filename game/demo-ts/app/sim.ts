...
export const ACTION_BITS = {
   ...
   *
   * Здесь они объявлены, но пока никем не назначены: раскладка устройств
   * (`bindings.json`) их не упоминает, а сцена демо ещё не описывает
   * способности платформой — до её миграции биты свободны и ни на что не
   * влияют.
   */
  confirm: 8,
  cancel: 9,
