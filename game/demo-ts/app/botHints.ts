 ...
 * следствия, ради которых форма и выбрана такой: схема сцены не растёт,
 * `contentPackHash` документа не видит (SER-7), и Blender-импорт его не
 * переписывает (BLND-2) — он переписывает только пространственный слой.
 *
